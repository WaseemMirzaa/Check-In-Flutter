...
class _OtherProfileViewState extends State<OtherProfileView>
  ...
  @override
  void dispose() {
    // _scrollController.dispose(); // Dispose the controller properly
                    ...
                    child: NotificationListener<ScrollNotification>(
                      onNotification: (ScrollNotification scrollInfo) {
                        ...
                        if (scrollInfo.metrics.pixels ==
                          ...
                          controller.fetchMoreUserPosts(
                              widget.uid); // Fetch more posts
                        }
                        return false;
                      },
                      child: Obx(() {
                        ...
                        final posts = controller
                            .userPosts; // Use the observable list directly
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                Container(
                                                  ...
                                                  child: Center(
                                                      child: Text(
                                                          "${snapshot.data!.userName}'s Posts")),
                                                ),
                                              ],
                                            ),
                                            const SizedBox(
              ...
              children: [
                Column(
                  children: [
                    ...
                    poppinsText(snapshot.data!.userName ?? "", 24,
                      ...
                      children: [
                        GestureDetector(
                          ...
                          child: Column(
                            children: [
                              Obx(() => poppinsText(
                                    followerCountController.followersCount.value
                                        .toString(),
                                    16,
                                    underline: true,
                                    bold,
                        ...
                        GestureDetector(
                          ...
                          child: Column(
                            children: [
                              Obx(() => poppinsText(
                                    followerCountController.followingCount.value
                                        .toString(),
                                    16,
                                    underline: true,
                                    bold,
                        ...
                        children: [
                          Obx(() => InkWell(
                                ...
                                child: Container(
                                  ...
                                  child: Center(
                                    child:
                                        sendMessageController.isFollowing.value
                          ...
                          Obx(() {
                            return Stack(
                              children: [
                                InkWell(
                                  onTap: sendMessageController.isLoading.value
                                      ? null
                                      : () async {
                            ...
                            builder: (context, courtsSnapshot) {
                              if (courtsSnapshot.connectionState ==
                                ...
                                return CircularPercentIndicator(
                                  ...
                                  lineWidth: 8.0,
                                  animation: true,
                                  percent: ((courtsSnapshot.data?.length ?? 0) /
                                          (totalCount ?? 10))
                                      .clamp(0.0, 1.0),
                                  center: Text(
                                    "${courtsSnapshot.data?.length ?? 0}\nCheck ins",
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(30)),
                      child: Center(
                          child: Text("${snapshot.data!.userName}'s Posts")),
                    ),
                  ],
                ),
                const SizedBox(
